...
<div class="card" style="width: 18rem;">
  <div class="card-body">
    ...
    <h6 class="card-subtitle mb-2 text-body-secondary">Laço Do While </h6>
    <p class="card-text">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        {
            echo "Digite um número entre 1 e 10 ou 0 para todas as tabuadas.";
        }
    }
    ?>
...
<div class="d-grid gap-2">
  <button class="btn btn-primary" type="button"> <a href="./dowhile.php"> Atualizar </a> </button>
</div>
